...
#export LINKER=""
export COMPILERDIR=$PARENT_DIR/clang-r536225
...
clang(){
  if [ ! -d $PARENT_DIR/clang-r536225 ]; then
    ...
    git clone --branch 15.0 --depth=1 https://gitlab.com/crdroidandroid/android_prebuilts_clang_host_linux-x86_clang-r536225 $PARENT_DIR/clang-r536225
  fi
}
